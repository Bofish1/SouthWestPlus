...
using SouthWestPlus.Areas.Identity.Data;

namespace SouthWestPlus.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(10, ErrorMessage = "The phone number field should have a maximum of 10 characters no special ")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //Register info added to database
                var user = CreateUser();
